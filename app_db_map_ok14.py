...
# ✅ ในหน้า My Lifestyle: ปรับปุ่ม ❤️
    ...
    home_button()
    st.subheader("💖 Match บ้านกับไลฟ์สไตล์ของคุณ")

    all_tags = sorted({tag for tags in df["lifestyle_tags"] for tag in tags})
    selected_tags = st.multiselect("เลือก Lifestyle ของคุณ", options=all_tags)
